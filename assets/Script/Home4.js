...
cc.Class({
    ...
    onLoad: function () {
        var size = cc.winSize;
        this.score_sprite.string = window.userData.score3.toString();
        this.node.convertToWorldSpaceAR(cc.p(0,0));
        this.bool = false;
        this.touch_able = false;

        //路径数组初始化
        this.path.push(cc.p(-1/2*size.width + 1/9*size.width, -1/2*size.height + 2/6*size.height));
        this.path.push(cc.p(-1/2*size.width + 2/9*size.width, -1/2*size.height + 2/6*size.height));
        this.path.push(cc.p(-1/2*size.width + 2/9*size.width, - 1/2*size.height + 3/6*size.height ));
        this.path.push(cc.p(-1/2*size.width + 3/9*size.width , - 1/2*size.height + 3/6*size.height ));
        this.path.push(cc.p(-1/2*size.width + 3/9*size.width, - 1/2*size.height + 2/6*size.height ));
        this.path.push(cc.p(-1/2*size.width + 4/9*size.width , - 1/2*size.height + 2/6*size.height ));
        
        this.path.push(cc.p(-1/2*size.width + 4/9*size.width, - 1/2*size.height + 4/6*size.height ));
        this.path.push(cc.p(-1/2*size.width + 5/9*size.width , - 1/2*size.height + 4/6*size.height ));
        this.path.push(cc.p(-1/2*size.width + 5/9*size.width, - 1/2*size.height + 2/6*size.height ));
        this.path.push(cc.p(-1/2*size.width + 6/9*size.width , - 1/2*size.height + 2/6*size.height ));
        this.path.push(cc.p(-1/2*size.width + 6/9*size.width, - 1/2*size.height + 3/6*size.height ));
        this.path.push(cc.p(-1/2*size.width + 7/9*size.width , - 1/2*size.height + 3/6*size.height ));
        this.path.push(cc.p(-1/2*size.width + 7/9*size.width, - 1/2*size.height + 2/6*size.height ));
        this.path.push(cc.p(-1/2*size.width + 8/9*size.width , - 1/2*size.height + 2/6*size.height ));
    ...
    update:function(){
        ...
        var k=15;
        if(delta > k && window.userData.score3>0){
            //更新旧位置
    ...
    demoEnd:function(){
        ...
        sc.name = 'LV2';
        window.userData.name = sc.name;
        sc.setPosition(cc.p(size.width*1/9 - size.width/2, size.height*5/6 - size.height/2 ));
        this.node.addChild(sc);
        this.scroll_array.push(sc);
        ...
        sc.name = 'LV3';
        window.userData.name = sc.name;
        sc.setPosition(cc.p(size.width*2/9 - size.width/2, size.height*4/6 - size.height/2 ));
        this.node.addChild(sc);
        this.scroll_array.push(sc);
        ...
        sc.name = 'LV4';
        window.userData.name = sc.name;
        sc.setPosition(cc.p(size.width*1/2 - size.width/2, size.height*3/6 - size.height/2 ));
        this.node.addChild(sc);
        this.scroll_array.push(sc);
        ...
        sc.name = 'LV5';
        window.userData.name = sc.name;
        sc.setPosition(cc.p(size.width*5/9 - size.width/2, size.height*1/6 - size.height/2 ));
        this.node.addChild(sc);
        this.scroll_array.push(sc);
        ...
        sc.name = 'LV6';
        window.userData.name = sc.name;
        sc.setPosition(cc.p(size.width*11/18 - size.width/2, size.height*2/6 - size.height/2 ));
        this.node.addChild(sc);
        this.scroll_array.push(sc);
        ...
        sc.name = 'LV7';
        window.userData.name = sc.name;
        sc.setPosition(cc.p(size.width*6/9 - size.width/2, size.height*4/6 - size.height/2 ));
        this.node.addChild(sc);
        this.scroll_array.push(sc);
