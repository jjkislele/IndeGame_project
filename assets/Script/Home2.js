...
cc.Class({
    ...
    onLoad: function () {
        ...
        //路径数组初始化
        this.path.push(cc.p(-4.5/9*size.width + 1/9*size.width, -1/2*size.height + 1/6*size.height));
        this.path.push(cc.p(-4.5/9*size.width + 3/9*size.width, -1/2*size.height + 1/6*size.height));
        this.path.push(cc.p(-4.5/9*size.width + 3/9*size.width, 4/6*size.height - 1/2*size.height));
        this.path.push(cc.p(7/9*size.width - 4.5/9*size.width, 4/6*size.height - 1/2*size.height));
    ...
    demoEnd:function(){
        ...
        sc.setPosition(cc.p(size.width*2/9 - size.width/2, size.height*1/6 - size.height/2 ));
        ...
        sc.name = 'LV2';
        window.userData.name = sc.name;
        sc.setPosition(cc.p(size.width*4/9 - size.width/2, size.height*4/6 - size.height/2 ));
        this.node.addChild(sc);
        this.scroll_array.push(sc);
        ...
        sc.name = 'LV3';
        window.userData.name = sc.name;
        sc.setPosition(cc.p(size.width*5/9 - size.width/2, size.height*3/6 - size.height/2 ));
        this.node.addChild(sc);
        this.scroll_array.push(sc);
        ...
        sc.setPosition(cc.p(size.width*8/9 - size.width/2, size.height*1/6 - size.height/2 ));
        this.node.addChild(sc);
        this.scroll_array.push(sc);
        ...
        sc.name = 'LV5';
        window.userData.name = sc.name;
        sc.setPosition(cc.p(size.width*3/9 - size.width/2, size.height*5/6 - size.height/2 ));
        this.node.addChild(sc);
        this.scroll_array.push(sc);
        /*
        for(var i=0; i<10; i++){
